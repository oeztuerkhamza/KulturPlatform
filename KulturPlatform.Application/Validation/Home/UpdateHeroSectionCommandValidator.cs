...
/// <summary>
/// Validator for UpdateHeroSectionCommand
/// </summary>
public sealed class UpdateHeroSectionCommandValidator : AbstractValidator<UpdateHeroSectionCommand>
{
    public UpdateHeroSectionCommandValidator()
    {
        // ID validation
        RuleFor(x => x.Id)
            .NotEmpty().WithMessage("Hero section ID is required");
