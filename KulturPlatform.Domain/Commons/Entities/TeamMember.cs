...
namespace KulturPlatform.Domain.Commons.Entities
{
    public class TeamMember : Entity
    {
        ...
        private TeamMember(Guid id, Name name, Title titleTr, Title titleDe, string imageUrl, int order)
            : base(id)
        {
            Name = name;
            TitleTr = titleTr;
        ...
        // Factory
        public static TeamMember Create(Name name, Title titleTr, Title titleDe, string imageUrl, int order)
        {
            ...
            return new TeamMember(Guid.NewGuid(), name, titleTr, titleDe, imageUrl, order);
        }

        // Update method
        public void Update(Name name, Title titleTr, Title titleDe, string imageUrl, int order)
        {
            Name = name ?? Name;
